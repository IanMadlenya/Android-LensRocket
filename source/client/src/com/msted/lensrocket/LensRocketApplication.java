...
public class LensRocketApplication extends Application {
	...
	public LensRocketApplication() {}
	
	public LensRocketService getLensRocketService() {
		if (mLensRocketService == null) {
			mLensRocketService = new LensRocketService(this);
		}
		return mLensRocketService;
	}	
